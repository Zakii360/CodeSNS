...
window.loginWithGithub = async function() {
    // Force the exact origin for static hosting redirects
    ...
    return `
        <div class="main-layout">
            ...
            <aside class="left-sidebar">
                ...
                <div class="user-card" onclick="${currentUser ? 'logout()' : 'loginWithGithub()'}">
                    <img src="${avatarUrl}" class="post-avatar" style="width: 40px; height: 40px;">
                    <div style="overflow: hidden;">
                        <div style="font-weight: 700; font-size: 0.9rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${currentUser?.full_name || 'Sign In'}</div>
                        <div style="font-size: 0.8rem; color: var(--text-muted);" class="font-mono">${currentUser ? '@'+currentUser.username : 'with GitHub'}</div>
                    </div>
                </div>
            </aside>
